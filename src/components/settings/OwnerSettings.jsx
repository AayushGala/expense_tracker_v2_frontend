      ...
      <Card className="p-5">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            type="button"
            onClick={handleAdd}
            className="self-start inline-flex items-center gap-1.5 text-xs font-medium text-teal-600 hover:text-teal-700 rounded-lg px-2 py-1.5 hover:bg-teal-50 transition-colors"
          >
        ...
        <div className="flex items-center gap-3 pt-4">
          <button
            onClick={handleSave}
            disabled={saving}
            className="rounded-xl bg-teal-600 px-5 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500/50 transition-colors disabled:opacity-60"
          >
            {saving ? 'Saving...' : 'Save'}
          </button>
          {saved && (
