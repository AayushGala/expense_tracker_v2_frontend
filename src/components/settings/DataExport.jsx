...
export default function DataExport() {
  ...
  const btnClass =
    'shrink-0 text-sm px-5 py-2.5 min-w-[160px] justify-center bg-brand text-white rounded-xl font-bold hover:bg-brand-hover flex items-center gap-2 transition-colors';
