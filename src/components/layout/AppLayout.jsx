  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50/80">
      ...
      <button
        ...
        className="fixed bottom-20 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-2xl bg-teal-600 text-white shadow-lg shadow-teal-600/30 transition-all hover:bg-teal-700 hover:shadow-xl hover:shadow-teal-600/40 active:scale-95 md:hidden"
      >
        <svg
