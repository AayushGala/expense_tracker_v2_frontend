...
const TYPE_ICONS = {
  expense: { bg: 'bg-rose-100', color: 'text-rose-600', path: 'M17 1l4 4-4 4M3 11V9a4 4 0 014-4h14M7 23l-4-4 4-4M21 13v2a4 4 0 01-4 4H3' },
  income: { bg: 'bg-emerald-100', color: 'text-emerald-600', path: 'M12 22V8M5 12l7-7 7 7' },
  transfer: { bg: 'bg-blue-100', color: 'text-blue-600', path: 'M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4' },
  bill_payment: { bg: 'bg-orange-100', color: 'text-orange-600', path: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
  investment: { bg: 'bg-violet-100', color: 'text-violet-600', path: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  cashback: { bg: 'bg-teal-100', color: 'text-teal-600', path: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  split_expense: { bg: 'bg-amber-100', color: 'text-amber-600', path: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  reimbursement: { bg: 'bg-cyan-100', color: 'text-cyan-600', path: 'M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6' },
};
