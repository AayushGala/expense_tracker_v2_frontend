        ...
        {SECTIONS.map((s) => (
          ...
          >
            <svg
              ...
              className={`h-3.5 w-3.5 flex-shrink-0 ${activeSection === s.id ? 'text-teal-500' : 'text-gray-400'}`}
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.8"
              ...
              {SECTIONS.map((s) => (
                <li key={s.id}>
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`h-4 w-4 flex-shrink-0 ${activeSection === s.id ? 'text-teal-500' : 'text-gray-400'}`}
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="1.8"
